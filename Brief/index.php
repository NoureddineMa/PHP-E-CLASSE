...
<html lang="en">
  ...
  <body class="for-bg">
    ...
    >
      <section
        class="rounded p-4 col-lg-4 col-md-6 col-sm-7 bg-white shadow px-5 py-5"
      >
        <section class="row">
          <form class="form-container">
            ...
            <div class="mb-4">
              <label for="InputEmail1" class="form-label mt-1">Email</label>
              <input
                type="email"
            ...
            <div class="mb-4">
              <label for="InputPassword1" class="form-label mt-1"
                >Password</label
              >
              <input
                type="password"
            ...
            <button
              type="submit"
              class="btn btn-info btn-lg w-100 text-white p-3 mt-2"
            >
